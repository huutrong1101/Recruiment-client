                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Do you want to discard this information? Your inputted
...
export default function FieldItemInput<T>({
  ...
  return (
    <div
      className={classNames(
        `flex flex-col gap-4 px-4 py-2 border border-gray-900/10`,
      ...
      {visible && (
        <>
          <div className="flex flex-col w-full gap-4 p-4">
            {schema.map(
              ({ display, id, type, placeholder }, _internalFieldIndex) => (
                <div key={_internalFieldIndex}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleFieldChange(index, id as any, e.target.value)
                    }
                  />
                </div>
              ),
