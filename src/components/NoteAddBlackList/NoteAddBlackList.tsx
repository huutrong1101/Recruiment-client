...
export default function NoteAddBlackList() {
  return (
  <div className = "w-[596px] h-[399px] pl-[117px] pr-[132px] py-[124px] bg-white justify-start items-center inline-flex">
    <div className = "w-[347px] h-[151px] relative">
      ...
      <div className = "w-[245px] h-[17px] left-[85px] top-[35px] absolute text-black text-[14px] font-medium leading-10">Are you sure you want to add BlackList ?</div>
      ...
      <button className = "w-[62px] h-[37px] left-[268px] top-[98px] absolute bg-red-600 bg-opacity-95 rounded-lg flex-col justify-center items-center inline-flex">
          <div className = "w-[58px] text-center text-white text-[12px] font-semibold capitalize leading-7 tracking-wide">AddBlackList</div>
      </button>
