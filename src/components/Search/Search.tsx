  ...
  return (
    <div className="flex justify-center ">
      <form
        ...
        className="ml-20 px-1.5 py-1 bg-white border bg-opacity-5  rounded-lg justify-start items-center gap-1 inline-flex"
      >
        <div className="flex justify-center items-center gap-3">
          <MagnifyingGlassIcon className="w-4 h-4 relative" />
          <input
            type="text"
            className="font-medium outline-none text-gray-900 text-[14px] w-[300px] h-[30px] text-left rounded-lg "
            value={searchQuery}
