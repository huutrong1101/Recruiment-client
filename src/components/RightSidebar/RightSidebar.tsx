            ...
            <div className="Notifications self-stretch h-[248px] flex-col gap-3 flex">
              ...
              <div className="Frame427318999 self-stretch h-[262px] flex-col justify-start items-start gap-2 flex">
                <div className="AvatarNameText self-stretch p-1 rounded-lg justify-start items-start gap-2 inline-flex">
                  <img  alt ="" className="D05 w-6 h-6 relative rounded-[800px]" src="https://via.placeholder.com/24x24" />
                ...
                <div className="AvatarNameText self-stretch p-1 rounded-lg justify-start items-start gap-2 inline-flex">
                  <img alt ="" className="Female05 w-6 h-6 relative rounded-[800px]" src="https://via.placeholder.com/24x24" />
                  <div className="Frame1 grow shrink basis-0 flex-col justify-start items-start inline-flex">
                ...
                <div className="AvatarNameText self-stretch p-1 rounded-lg justify-start items-start gap-2 inline-flex">
                  <img alt ="" className="Male07 w-6 h-6 relative rounded-[800px]" src="https://via.placeholder.com/24x24" />
                  <div className="Frame1 grow shrink basis-0 flex-col justify-start items-start inline-flex">
                ...
                <div className="AvatarNameText self-stretch p-1 rounded-lg justify-start items-start gap-2 inline-flex">
                  <img alt ="" className="D08 w-6 h-6 relative rounded-[800px]" src="https://via.placeholder.com/24x24" />
                  <div className="Frame1 grow shrink basis-0 flex-col justify-start items-start inline-flex">
                ...
                <div className="AvatarNameText self-stretch p-1 rounded-lg justify-start items-start gap-2 inline-flex">
                  <img alt ="" className="Male11 w-6 h-6 relative rounded-[800px]" src="https://via.placeholder.com/24x24" />
                  <div className="Frame1 grow shrink basis-0 flex-col justify-start items-start inline-flex">
