...
export default function AddBlacklist() {
  ...
  const jobs: AcountFrofileInterface[] = useAppSelector(
    (state) => state.adminacountuseprofileRecent.adminacountuseprofileRecent,
  );
  ...
  const handleSubmit = async (event: any) => {
    ...
    setOpen(false);
    axiosInstance
      .post(`admin/users/blacklist/${userId}`, { reason })
      .then((response) => {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <div
          className="flex gap-5 md:flex mt-10 "
          ...
          <div className="bg-white rounded-lg shadow-lg w-1/3 mt-10 ml-10">
            <div className="grid md:grid-cols-1 text-sm self-stretch px-2 pt-[13px] pb-[11px]">
              ...
              <div className="grid grid-cols-1">
                ...
                <input
                  className="px-4 py-2 self-stretch pt-[13px] pb-[11px] bg-white bg-opacity-0 rounded-lg border border-zinc-900 border-opacity-50"
          ...
          <div className="p-4 border mt-10 w-1/2 rounded-xl border-zinc-100">
            ...
            <div className={classnames("mt-10 text-center px-5 py-4")}>
              <NavLink to="#" onClick={goBack}>
                <button
                  type="submit"
                  className="px-6 py-3 text-white rounded-xl bg-red-600 hover:bg-red-800"
                >
                  {" "}
                  Cancel{" "}
                </button>
                ...
                <div className="text-center px-6">
                  ...
                  >
                    <h1 className=" font-semibold  text-lg mb-2">
                      {" "}
                      Are you sure you want to add menber to Blacklist ?
                    </h1>
                  ...
                  >
                    ...
                    >
                      <p>
                        You definitely want to continue. Be careful with your
                        decisions
                      </p>
                    </div>
                  </DialogContentText>
