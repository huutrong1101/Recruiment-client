...
const AdminProfile = () => {
  const { adminprofilesRecent, adminprofilesRecentStatus } = useAppSelector(
    (state: any) => state.adminprofilesRecent,
  );
    ...
    return (
      <div className="flex gap-2 mt-10 border">
        <div className="bg-white rounded-lg shadow-lg w-[50%] flex justify-center items-center">
          <div>
            <img
              src={adminprofilesRecent.avatar}
        ...
        <div className="bg-white rounded-lg shadow-lg w-[50%] h-fit sticky">
          <div className="flex items-center justify-center text-center space-x-2 font-semibold text-green-500">
            <span className="tracking-wide text-bold-center flex text-emerald-600 text-[30px]">
              Information
            </span>
          </div>
            ...
            <div className="grid md:grid-cols-1 text-sm self-stretch px-2 pt-[13px] pb-[13px]">
              ...
              <div className="grid grid-cols-1">
                ...
                <input
                  ...
                  className="px-4 py-2 self-stretch pt-[13px] pb-[13px] bg-white bg-opacity-0 rounded-lg border border-zinc-900"
                  placeholder={adminprofilesRecent.Fullname}
              ...
              <div className="grid grid-cols-1">
                ...
                <input
                  ...
                  className="px-4 py-2 self-stretch pt-[13px] pb-[13px] bg-white bg-opacity-0 rounded-lg border border-zinc-900"
                  placeholder={adminprofilesRecent.phone}
              ...
              <div className="grid grid-cols-1">
                ...
                <input
                  ...
                  className="px-4 py-2 self-stretch pt-[13px] pb-[13px] bg-white bg-opacity-0 rounded-lg border border-zinc-900"
                  placeholder={adminprofilesRecent.email}
              ...
              <div className="grid grid-cols-1">
                ...
                <input
                  ...
                  className="px-4 py-2 self-stretch pt-[13px] pb-[13px] bg-white bg-opacity-0 rounded-lg border border-zinc-900"
                  placeholder={adminprofilesRecent.address}
