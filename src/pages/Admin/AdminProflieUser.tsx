...
export default function AdminProflieUser() {
  ...
  const jobs: AcountFrofileUsersInterface[] = useAppSelector(
        ...
        <div className="flex flex-wrap mx-4 mt-[50px]">
          <div className="w-full px-4 mb-10 md:w-1/3 ">
            <div className="bg-white rounded-lg shadow-lg mt-5 ">
              {/* Avatar */}
              <div className="mt-20">
                <div className="px-4 py-2 mb-2 font-semibold text-black capitalize leading-7 tracking-wide text-center">
                  Avatar Users
                </div>
          ...
          <div className="w-full px-4 mb-10 md:w-1/2 ">
            <div className="bg-white rounded-lg shadow-lg w-full border">
              ...
              <div className="grid grid-cols-1">
                ...
                <input
                  className="ml-5 px-4 mr-5  py-2 self-stretch pt-[15px] pb-[15px] bg-white bg-opacity-0 rounded-lg border   "
              ...
              <div className="grid grid-cols-1">
                ...
                <input
                  className="ml-5  mr-5 px-4 py-2 self-stretch pt-[15px] pb-[15px] bg-white bg-opacity-0 rounded-lg border   "
