  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative w-full px-8 -mt-28">
        ...
        <div className="grid grid-cols-3 grid-rows-4 gap-0">
          ...
          <div className="col-start-3 row-span-3 row-start-1 px-8 py-4 mt-8 Info">
            <div className="sticky grid grid-cols-2 px-2 py-4 bg-gray-100 rounded-3xl drop-shadow-lg top-2">
              <div className="col-start-1 px-4 font-semibold">
                Personal Detail:
              </div>
              <table className="table w-full col-span-2 col-start-1 px-4 py-6 border-collapse">
                <tbody>
                  {personalDetails.map((detail) => (
                    <tr key={detail.label} className="font-light">
                      ...
                      <td className="px-4 py-2 text-right">{detail.value}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
              <div className="flex flex-col items-center col-span-2 col-start-1 mx-5 text-center bg-white shadow-inner rounded-xl">
                <p className="flex flex-row px-2 mx-2 my-1">
                  {" "}
                  <DocumentTextIcon className="w-7 h-7" />
                  rosaria-varagas-resume.pdf
                </p>
                <button className="flex flex-row p-2 px-4 mx-2 my-1 text-white bg-green-700 rounded-lg hover:bg-green-900">
          ...
          {/* DESCRIPTION */}
          <div className="col-span-2 p-6 mt-8 bg-white Desc">
          ...
          {/* SKILL */}
          <div className="col-span-2 p-6 mt-8 bg-white Skill">
            ...
            <div className="flex flex-wrap p-4">
              {listSkills.map((item, index) => (
                <div key={index}>
                  <span
                    key={index}
                    className="p-2 mx-2 my-1 text-white bg-green-700 rounded-lg"
                  >
                    {item}
                  </span>
                </div>
          ...
          {/* EXPERIENCE */}
          <div className="col-span-2 p-6 mt-8 bg-white Exp">
        ...
        {/* INTERVIEW HISTORY */}
        <div className="p-6 mt-8 bg-white History">
