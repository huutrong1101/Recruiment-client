    ...
    <>
      ...
      >
        <span className="text-gray-600 text-sm">
          Once you deleted, the data is permanently removed and it cannot be
          recovered.
        </span>
      </Dialog>
    </>
      ...
      {isLoading ? (
        ...
        <div className={classNames(`job-detail`)}>
          ...
          >
            ...
            <div
              className={classnames(
                "w-full md:w-8/12 border shadow rounded-xl",
              )}
            >
              {/* Img */}
              ...
              >
                <div className="flex flex-row gap-2 w-full px-10">
                  <PrimaryButton
                    text="Delete"
