...
export default function InterviewerDetail() {
  ...
  const [InterviewerInformation, setInterviewerInformation] = useState([
    ...
    { icon: <MapPinIcon />, name: "", value: "" },
    {
      icon: <ComputerDesktopIcon />,
      name: "",
      value: "",
    },
    { icon: <BriefcaseIcon />, name: "", value: "" },
    { icon: <AcademicCapIcon />, name: "", value: "" },
    {
  ...
  useEffect(() => {
    if (interviewer) {
      setInterviewerInformation([
        { icon: <UserIcon />, name: "Email", value: interviewer?.email },
        { icon: <MapPinIcon />, name: "D.O.B", value: moment(interviewer?.dateOfBirth).format("Do MMM, YYYY") },
        {
          icon: <ComputerDesktopIcon />, name: "Address", value: interviewer.address,
        },
        {
          icon: <CurrencyDollarIcon />, name: "Phone", value:  formatPhoneNumber(interviewer?.phone),
        },
        {
          icon: <ClockIcon />, name: "Posted at", value: interviewer.email,
        },
      ]);
    }
  }, [interviewer]);
