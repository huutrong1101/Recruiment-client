          ...
          <div className="relative h-1/2 flex flex-col mx-2 gap-y-2">
            ...
            <div className="bg-gray-100 h-[200px] w-full rounded-lg border-black px-2 py-2 relative ">
                  ...
                  <table className="w-full ">
                    <thead className="">
                      <tr className="flex flex-row gap-x-2 ">
                        <th className="text-sm tracking-wide text-left font-semibold pt-4 basis-1/5 ">
                          Position
                        </th>
                        <th className="text-sm tracking-wide text-left font-semibold pt-4 basis-1/5 ">
                          Tech
                        </th>
                        <th className="text-sm tracking-wide text-left font-semibold pt-4 basis-3/5 ">
                          Question
                        </th>
                      </tr>
                    </thead>
                    <tbody className="">
                      <div className="grid text-left">
                        <tr className="flex flex-row gap-x-2 text-left text-sm">
                          ...
                          <td className="basis-3/5 flex-nowrap">
                            How create API?
                          </td>
                        </tr>
                        <tr className="flex flex-row gap-x-2 text-left text-sm ">
              ...
              <div className="absolute  flex top-[-10px] left-[-10px]">
                <div className="flex flex-row  gap-x-10 pl-2 ">
                  <div className=" w-1/5 ">
                    <button
                      className="Text text-white px-4 py-2.5 bg-emerald-600 rounded-s-lg drop-shadow-lg mr-4  
                  ...
                  <div className=" w-1/5 h-[50px] ">
                    <button
                      className="Text text-white px-4 py-2.5 bg-emerald-600 rounded-e-lg drop-shadow-lg mr-4  
                                                text-[14px] font-medium leading-tight hover:text-emerald-600 hover:bg-white
                                                border-transparent border hover:border-emerald-600 hover:transition-all  "
                    >
                      Technology
            ...
            <div className="bg-emerald-600 h-1/2 w-full rounded-lg border-black px-2 py-2 pb-2 relative flex flex-col">
              <div className="flex flex-row justify-between mx-4 gap-x-6 ">
                <div className="text-white font-semibold flex flex-col w-full items-center">
                  Question
                  <div className="w-full h-[30px] bg-white rounded-md relative "></div>
                  <input
                    type="text"
                    className="flex flex-col w-full h-[50px] bg-white rounded-md py-2 m-2 text-black break-words"
                    placeholder="    Note..."
                  ></input>
                </div>
                <div>
                  <div className="text-white text-left font-semibold mr-4 flex flex-col w-full items-center">
                    Score
                    <input
                      type="text"
                      className="w-2/3 h-[30px] bg-white rounded-md px-2 py-2 text-black"
                    />
                  </div>
                </div>
              </div>
