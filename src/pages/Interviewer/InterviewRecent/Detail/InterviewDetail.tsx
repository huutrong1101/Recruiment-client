      ...
      <div className="InterviewDetail ">
        ...
        <div className="mt-4">
          <div className="text-base">
            Position Recruiment:{" "}
            <span className="ml-2 text-sm">{INTSingleInterview?.position}</span>
          </div>
          <div className="text-base">
            Date:{" "}
              ...
              <tbody>
                {assignedQuestions?.map((item: any) => (
                  <tr key={item.questionId} className="bg-white">
                    ...
                    <td className="px-4 py-2 border">{item.typeQuestion}</td>
                    <td className="px-4 py-2 border">{item.skill}</td>
