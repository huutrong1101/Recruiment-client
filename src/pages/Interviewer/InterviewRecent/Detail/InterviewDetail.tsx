...
import { assignQuestions, fetchINTQuestionData, removeQuestions } from "../../../../redux/reducer/INTQuestionsSlice";
...
const InterviewDetail = () => {
    ...
    const {searchQuestions, searchQuestionsStatus, questionsForInterview} = useAppSelector((state: any) => state.INTQuestions);
                                ...
                                <table className="w-full table-auto border-collapse border border-gray-300 rounded">
                                    ...
                                    {questionsForInterview.map((item : any) => (
                                        ...
                                        <td className="border px-4 py-2">
                                            <TrashIcon onClick={() => handleRemove(item)} className="cursor-pointer w-5 h-5 text-gray-500"/>
                                        </td>
                                        </tr>
                                    ))}
                                    </tbody>
