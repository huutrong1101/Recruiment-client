        ...
        <div>
          <h2 className={`text-2xl`}>
            {errorCode === STATUS.ERROR500 && (
              <p>
                Oops! Something went wrong on our end. We are experiencing
                technical difficulties and our team is already working to fix
                it. Please try again later. We apologize for the inconvenience.
              </p>
            )}
            {errorCode === STATUS.ERROR404 && (
              <p>
                Oops! The page you are looking for could not be found. It might
