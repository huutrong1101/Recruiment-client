    ...
    reducers: {
        ...
        selectQuestions(state, action : PayloadAction<{ ID: string, question: any }>){   
            ...
            if (interviewID in state.selectedQuestions){
                const isQuestionExist = state.selectedQuestions[interviewID].find(item => item.questionId === question.questionId);
        ...
        removeQuestions(state, action : PayloadAction<{ ID: string, question: any }>){        
            const { ID : interviewID, question } = action.payload;
            state.selectedQuestions[interviewID] = state.selectedQuestions[interviewID].filter(item => item.questionId !== question.questionId );
        },
...
export const {selectQuestions, removeQuestions, setEmptySelectedQuestions, setScore, setNote} = INTQuestionsSlice.actions;
